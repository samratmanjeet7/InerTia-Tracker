...
export default function Box1() {
  useEffect(() => {
    document.title = "About |  Inertia Tracker";
  });
              ...
              >
                <Box>
                  ...
                  <Text
                    ...
                    mb="30px"
                  >
                    DeskTime was born out of the need for the Draugiem Group to
                    manage their many employees. An internal application was
                    developed, and we soon realized that we'd made a tool that
                    could be useful for many other companies. Why not offer it
                    to them? - we thought. And so, the development began.
                  </Text>
                  <Text textAlign="left" lineHeight="20px" color="#475056">
                    At DeskTime, we’re committed to accountability,
                    transparency, and fairness. DeskTime is a product designed
                    to increase productivity in an open and empowering
            ...
            <Box>
              <Box>
                <AboutTimeline
                  ...
                  date="April 2022"
                  heading="DeskTime introduces the new Booking feature"
